...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2014, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '里昂', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '出来混，出来最重要~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://onon.li', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '林草,报白,出评,软件,多多资金解冻,博客', // 网站关键词 英文逗号隔开
